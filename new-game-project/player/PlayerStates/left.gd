...
func on_physics_process(delta):	
	controlled_node.play_animation(controlled_node.animations.left)
...
func on_input(_event):
	if Input.is_action_pressed("ui_right") and Input.is_action_pressed("ui_up") and not Input.is_action_pressed("ui_left"): 
		state_machine.change_to(player.states.UpRight)
	elif Input.is_action_pressed("ui_right") and Input.is_action_pressed("ui_down") and not Input.is_action_pressed("ui_left"): 
	...
	elif Input.is_action_pressed("ui_up") and not Input.is_action_pressed("ui_left"):  
		state_machine.change_to(player.states.Up)
	elif Input.is_action_pressed("ui_down") and not Input.is_action_pressed("ui_left"):  
