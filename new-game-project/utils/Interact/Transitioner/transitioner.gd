...
@export_enum("ROOM-4", "ROOM-5", "ROOM-6","ROOM-LABOSYH", "ROOM-PASILLO1","ROOM-LABOFISICA","ROOM-ENTRADA","ROOM-PASILLO2","ROOM-SALACOMUN","ROOM-CENTROALUMNOS","ROOM-SALA-CAMARAS","VACIO")
